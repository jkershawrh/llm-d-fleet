...
## `v0.4.0-rc.1` review candidate

The `v0.4.0-rc.1` pre-release is newer than `v0.3.0`. It adds the portable
...
an explicit threat model. These changes are candidate evidence and must not be
attributed to the stable `v0.3.0` release. Start with the
